...
| 4                    | 2            | Version this archive was created by. Doggy Bag sets this to `0x003F`.                                                                                                                                                                                           |
| 6                    | 2            | Minimum version needed to extract the file. Set to `0x000A` by Doggy Bag.                                                                                                                                                                                       |
| 8                    | 2            | General purpose bit flag. Used to for additional features such as encryption. Doggy Bag does not utilise these features. Therefore, it is set to `0x0000`.                                                                                                      |
| 10                   | 2            | Compression method. Doggy Bag sets this to `0x0000` to indicate that no compression is used. Data is simply stored.                                                                                                                                             |
| 12                   | 2            | File last modified time in MS-DOS formatting [2].                                                                                                                                                                                                               |
| 14                   | 2            | File last modified date in MS-DOS formatting [2].                                                                                                                                                                                                               |
| 16                   | 4            | CRC-32 of the file data. Doggy Bag uses the ISO HDLC algorithm.                                                                                                                                                                                                 |
...
| 30                   | 2            | The extra field length. Doggy Bag does not use extra fields. Therefore, this is set to `0x0000`.                                                                                                                                                                |
| 32                   | 2            | The length of the file comment. Doggy Bag does not add comments. Therefore, this is set to `0x0000`.                                                                                                                                                            |
| 34                   | 2            | The disk number where the file starts. This field is typically used where the archive is split across multiple disks (eg. floppy disks). Given that there is no need for such a field in the archive's Doggy Bag will be dealing with, this is set to `0x0000`. |
...
| 38                   | 4            | External file attributes. Used to indicate things like the file system and operating system on which the archive was created. Given that Doggy Bag operates within Web Assembly memory, none of the provided options make sense. This is set to `0x0000`.       |
...
| 46 + n               | m            | Extra field. Unused by Doggy Bag, therefore completely omitted.                                                                                                                                                                                                 |
| 46 + n + m           | k            | File comment. Unused by Doggy Bag, therefore completely omitted.                                                                                                                                                                                                |
...
| 4                    | 2            | Number of this disk. This is typically used when the archive has been split across multiple disks. Given that Doggy Bag does not split archives, this is set to `0x0000`.                                   |
| 6                    | 2            | Number of the disk where the central directory starts. This is typically used when the archive has been split across multiple disks. Given that Doggy Bag does not split archives, this is set to `0x0000`. |
| 8                    | 2            | Number of central directory records on this disk. This is equal to the total number of central directory records since Doggy Bag does not split archives.                                                   |
...
| 20                   | 2            | File comment length. Unused by Doggy Bag, therefore set to `0x0000`.                                                                                                                                        |
| 22                   | n            | Doggy Bag does not use comments. This field is completely omitted.                                                                                                                                          |
